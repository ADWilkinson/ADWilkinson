...
**London** · Senior Engineer at [Peer](https://peer.xyz) · Former Founder of [Galleon DAO](https://github.com/GalleonDAO) · [@davyjones0x](https://twitter.com/davyjones0x)

Building P2P fiat-to-crypto infrastructure at Peer and shipping AI dev tools on the side. I structure every repo for agent autonomy, not manual coding.
...
Senior Software Engineer at [Peer](https://peer.xyz), building P2P fiat rails with ZK payment verification on Base. My focus is the product and infrastructure around using the protocol: trading surfaces, liquidity tooling, analytics.
...
I started building AI dev tools when the Claude Agent SDK first came out, before most orchestration frameworks existed.

- **[Oneshot CLI](https://www.npmjs.com/package/oneshot-ship)** - Give it a repo and a task. Plans with Claude, executes with Codex, reviews the diff, opens a PR. [`github`](https://github.com/ADWilkinson/oneshot-cli)
...
- **[Galleon DAO](https://github.com/GalleonDAO)** - DeFi structured products protocol. Raised $1M seed from 1kx, scaled to $20M+ TVL.
- **[Broadside.fun](https://broadside.fun)** - Multiplayer browser naval combat. PixiJS, Socket.IO.
- **[KnowFulham](https://knowfulham.com)** - Local guide to Fulham with MapLibre and PostGIS.
